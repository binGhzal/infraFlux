...
const devDefaults: Partial<GlobalConfig> = {
  cluster: {
    nodes: [
      { name: 'control-1', role: 'control-plane', specs: { cores: 2, memory: 4096 } },
...
const prodDefaults: Partial<GlobalConfig> = {
  cluster: {
    nodes: [
      { name: 'control-1', role: 'control-plane', specs: { cores: 4, memory: 8192 } },
      { name: 'control-2', role: 'control-plane', specs: { cores: 4, memory: 8192 } },
      { name: 'control-3', role: 'control-plane', specs: { cores: 4, memory: 8192 } },
