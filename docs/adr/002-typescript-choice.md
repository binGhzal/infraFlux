...
With the decision to adopt Pulumi as our unified Infrastructure as Code platform, we need to select
a programming language for implementing all infrastructure components. Pulumi supports multiple
languages including TypeScript, Python, Go, C#, and Java.
...
We will use TypeScript as the primary programming language for all InfraFlux v2.0 infrastructure
code.
...
- **Compile-time Error Detection**: TypeScript's static typing catches configuration errors before
  deployment
...
This decision will be reviewed after 6 months of implementation or if significant TypeScript
